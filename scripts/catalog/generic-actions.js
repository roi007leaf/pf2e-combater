...
const GENERIC_ACTION_DEFS = [
  ...
  },
  {
    ...
    requiresEnemyInReach: true,
    requiresFreeHand: true,
    freeHandWeaponTraits: ["trip", "ranged-trip"],
    criticalFailureRisk: "major",
    attackTrait: true,
    executable: "pf2e-action",
  },
  ...
  },
  {
    ...
    requiresEnemyInReach: true,
    requiresFreeHand: true,
    freeHandAlternativeTargetConditions: ["grabbed", "restrained"],
    criticalFailureRisk: "major",
    attackTrait: true,
    executable: "pf2e-action",
  },
  {
    ...
    requiresEnemyInReach: true,
    requiresFreeHand: true,
    freeHandWeaponTraits: ["shove", "ranged-shove"],
    criticalFailureRisk: "major",
    attackTrait: true,
    executable: "pf2e-action",
  },
